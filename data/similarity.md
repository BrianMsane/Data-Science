...
Outlier analysis also employees clustering-based techniques to identify potential outliers as objects that are highly dissimilar to the others. Knowledge of object similarity can also be used in nearest-neighbor classification schemes where a given object is assigned a class label based on its similarity towards the other objects in the model.
